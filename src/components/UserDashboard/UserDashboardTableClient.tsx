  ...
  return (
    <>
      ...
      <SharedModal
        ...
        isSaving={isSaving}
      >
        <div className="p-4 text-center text-muted-foreground whitespace-pre-wrap">
          User creation form placeholder.
          ...
          <div className="space-y-4">
             <div className="flex justify-center">
                <div className="h-24 w-24 rounded-full overflow-hidden border-2 border-palmPrimary bg-muted flex items-center justify-center text-3xl font-bold">
                   {viewingUser.image ? <img src={viewingUser.image} alt={viewingUser.userName} className="h-full w-full object-cover" /> : viewingUser.userName.charAt(0).toUpperCase()}
                </div>
             </div>
